...
public class LocalMusicList extends Base implements MusicList {

    public LocalMusicList(MusicList _base, Activity _activity) {
        super(_base, _activity);
    }

    public LocalMusicList(Activity _activity) {
        super(_activity);
    }
